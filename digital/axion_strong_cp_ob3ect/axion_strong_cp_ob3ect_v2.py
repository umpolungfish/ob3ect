...
print("    ⟨Ð=𐑛; T=𐑥; R=𐑾; P=𐑹; f=𐑐; K=𐑧; G=𐑔; Gm=𐑝; ⊙=⊙; H=𐑫; S=𐑕; Ω=𐑷⟩")
print("    P=𐑹 (Frobenius-special, θ ∈ {0, π})")
print()
print("  Intermediate (axion phase):")
print("    ⟨Ð=𐑦; T=𐑶; R=𐑽; P=𐑬; f=𐑐; K=𐑧; G=𐑔; Gm=𐑠; ⊙=𐑻; H=𐑫; S=𐑳; Ω=𐑭⟩")
print("    P=𐑬 (Z₂ partial parity), Ph=𐑻 (exceptional point)")
print()
print("  Final (θ resolved):")
print("    ⟨Ð=𐑦; T=𐑸; R=𐑾; P=𐑹; f=𐑐; K=𐑧; G=𐑲; Gm=𐑵; ⊙=⊙; H=𐑫; S=𐑳; Ω=𐑟⟩")
