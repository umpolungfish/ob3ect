...
noncomputable def full_proof_protocol : IGProtocol full_proof_s0 full_proof_s11 :=
  .withGram Grammar.measure <|
  -- Dual-Link self-pairing: .prod arms fuse via tensorProduct full_proof_s9 full_proof_s9 = full_proof_s9 (idempotent)
  (.seq (.arrow full_proof_l0 full_proof_s0 full_proof_s1) (.seq (.prod (.arrow full_proof_l1 full_proof_s1 full_proof_s9) (.arrow full_proof_l1 full_proof_s1 full_proof_s9)) (.seq (.arrow full_proof_l9 full_proof_s9 full_proof_s9) (.seq (.arrow full_proof_l9 full_proof_s9 full_proof_s10) (.arrow full_proof_l10 full_proof_s10 full_proof_s11)))))

-- ── Evaluation arm sub-defs ───────────────────────────────────

-- truth arm
noncomputable def full_proof_true_arm : IGProtocol full_proof_s0 full_proof_s11 :=
  (full_proof_protocol).restrictToEVALT

-- false arm
noncomputable def full_proof_false_arm : IGProtocol full_proof_s0 full_proof_s11 :=
...
def full_proof_tier : OuroboricityTier := TierFunctor.obj full_proof_s11
...
theorem full_proof_frobenius :
    igFrobeniusAlg.mul full_proof_s0 full_proof_s0 = full_proof_s0 :=
  igFrobAlg_self_fusion full_proof_s0
