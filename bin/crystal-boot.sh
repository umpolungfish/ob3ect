...
#    𐑲(2); 𐑠(2); ⊙(1); 𐑖(2); 𐑳(2); 𐑭(2)⟩
#
# Indices per Crystal.lean:
#   D=3, R=3, ∈=2, H=2, Ω=2  → f4 = 3*256 + 3*64 + 2*16 + 2*4 + 2 = 1002
#   T=4, P=4, <=1, K=2       → f5 = 4*125 + 4*25 + 1*5 + 2 = 607
...
cmd_address() {
    ...
    echo "Tuple: ⟨𐑦; 𐑸; 𐑾; 𐑹; 𐑐; 𐑧; 𐑲; 𐑠; ⊙; 𐑖; 𐑳; 𐑭⟩"
    echo ""
